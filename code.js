...
function showDragTable(q) {
    ...
    dropZones.forEach(zone => {
        ...
        //                 "#relief .drag-item, #cover .drag-item"
        //             ).length;

        //         // setAnswered(placed === questions[q].option.length);
        //         setAnswered(placed > 0);
        //     }
        // });
    });
    showTableInput(q);
...
function showCompass(q) {
    ...
    document.querySelectorAll(".compass-drop").forEach(zone => {
        ...
        //         const existingItem = zone.querySelector(".dir-item");
    ...
    function endDrag(e) {
        ...
        if (zone) {
            if (
                ...
                const existing =
                    zone.querySelector(".dir-item");

                if (existing && existing !== item) {
                    document
                        .querySelector(".dir-bank")
